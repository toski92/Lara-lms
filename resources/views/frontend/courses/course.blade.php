               ...
               <div class="course-details-content-wrap pt-90px">
                   <div class="course-overview-card bg-gray p-4 rounded">
                       ...
                       <ul class="generic-list-item overview-list-item">
                        ...
                        <li><i class="la la-check mr-1 text-black"></i>  {{ $meta->meta_name }} </li>
                        @endforeach
                   ...
                   <div class="course-overview-card">
                       ...
                       <div class="collapse" id="collapseMore">
                        ...
                        <p class="fs-15 pb-2"> {{ $course->excerpt }} </p>
                       </div>
                   ...
                   <div class="course-overview-card">
                       <div class="curriculum-header d-flex align-items-center justify-content-between pb-4">
                           ...
                           <div class="curriculum-duration fs-15">
                            <span class="curriculum-total__text mr-2"><strong class="text-black font-weight-semi-bold">Total:</strong> {{ count($lectures) }} lectures</span>
                            <span class="curriculum-total__hours"><strong class="text-black font-weight-semi-bold">Total hours:</strong> {{ $course->duration }}</span>
                           </div>
                       </div>
                       @php
                            $topics = App\Models\Topic::where('course_id',$course->id)->orderBy('id','asc')->get();
                        @endphp
                       <div class="curriculum-content">
                           <div id="accordion" class="generic-accordion">
                            ...
                            @php
                                $lectures = App\Models\Lecture::where('topic_id',$topic->id)->get();
                            @endphp

                            <div class="card">
                                <div class="card-header" id="heading{{ $topic->id }}">
                                    <button class="btn btn-link d-flex align-items-center justify-content-between" data-toggle="collapse" data-target="#collapse{{ $topic->id }}" aria-expanded="true" aria-controls="collapse{{ $topic->id }}">
                            ...
                            <div class="media media-card">
                                <div class="instructor-img">
                                    <a href="teacher-detail.html" class="media-img d-block">
                                        <img class="lazy" src="{{ (!empty($course->user->photo)) ? url('upload/'.$course->user->photo) : url('upload/no_image.jpg')}}" data-src="images/small-avatar-1.jpg" alt="Avatar image">
                                    </a>
                                    <ul class="generic-list-item pt-3">
                                        ...
                                        <li><i class="la la-play-circle-o mr-2 text-color-3"></i> {{ count($instructor_courses) }} Courses</li>
                   ...
                   <div class="course-overview-card pt-4">
                        ...
                        <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                            <div class="media-img mr-4 rounded-full">
                                <img class="rounded-full lazy" src="{{ (!empty($item->user->photo)) ? url('upload/'.$item->user->photo) : asset('backend/assets/images/avatars/avatar-2.png')}}" data-src="images/small-avatar-1.jpg" alt="User image">
                            </div>
                            <div class="media-body">
                        ...
                        <div class="card-body">
                            <div class="preview-course-video">
                                <a href="javascript:void(0)" data-toggle="modal" data-target="#previewModal">
                                    <img src="{{ asset($course->feature_image) }}" data-src="images/preview-img.jpg" alt="course-img" class="w-100 rounded lazy">
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            ...
                            <ul class="generic-list-item generic-list-item-flash">
                                ...
                                <li class="d-flex align-items-center justify-content-between"><span><i class="la la-lightbulb mr-2 text-color"></i>Skill level</span> {{ $course->level }}</li>
                        ...
                        <div class="card-body">
                            ...
                            <div class="media media-card border-bottom border-bottom-gray pb-4 mb-4">
                                <a href="course-details.html" class="media-img">
                                    <img class="mr-3 lazy" src="{{ asset($related->feature_image) }}" data-src="{{ asset($related->feature_image) }}" alt="Related feature image">
                                </a>
                                <div class="media-body">
    ...
    <div class="container">
        <div class="related-course-wrap">
            ...
            <div class="view-more-carousel-2 owl-action-styled">
                @foreach ($instructor_courses  as $inscourse)
                    @php
                ...
                <div class="card card-item">
                    <div class="card-image">
                        <a href="{{ url('courses/'.$inscourse->id.'/'.$inscourse->slug) }}" class="d-block">
                            <img class="card-img-top" src="{{ asset($inscourse->feature_image) }}" alt="Card image cap">
                        </a>
                        @if ($inscourse->featured != NULL)
                    ...
                    <div class="card-body">
                        <h6 class="ribbon ribbon-blue-bg fs-14 mb-3">{{ $inscourse->level }}</h6>
                        <h5 class="card-title"><a href="course-details.html">{{ $inscourse->excerpt }}</a></h5>
            ...
            <div class="modal-body">
                <div class="copy-to-clipboard">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control form--control copy-input pl-3" value="{{ Request::fullUrl() }} ">
                        <div class="input-group-append">
...
<div class="modal fade modal-container" id="previewModal" tabindex="-1" role="dialog" aria-labelledby="previewModalTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <video controls crossorigin playsinline poster="{{ asset($course->feature_image) }}" id="player">
                    <!-- Video files -->
