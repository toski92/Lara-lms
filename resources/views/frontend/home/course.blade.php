                            ...
                            <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1{{ $course->id }}">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="py-2 rating-wrap d-flex align-items-center">
                                        ...
                                        <span class="pl-1 rating-total">({{ count($reviewcount) }})</span>
                                    </div><!-- end rating-wrap -->
    ...
    <div id="tooltip_content_1{{ $item->id }}">
        <div class="card card-item">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <button type="submit" class="btn theme-btn flex-grow-1 mr-3" onclick="addToCart({{ $item->id }}, '{{ $item->course_name }}','{{ $item->instructor_id }}','{{ $item->slug }}' )" ><i class="la la-shopping-cart mr-1 fs-18"></i>Add to Cart</button>
