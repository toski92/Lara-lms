        ...
        <div class="breadcrumb-content">
            <div class="media media-card align-items-center pb-4">
                <div class="media-img media--img media-img-md rounded-full">
                    <img class="rounded-full" src="{{ (!empty($instructor->photo)) ? url('upload/'.$instructor->photo) : url('upload/no_image.jpg')}}" alt="Student thumbnail image">
                </div>
                ...
                <div class="card card-item card-preview" data-tooltip-content="#tooltip_content_1{{ $course->id }}">
                    <div class="card-image">
                        <a href="{{ url('courses/'.$course->id.'/'.$course->slug) }}" class="d-block">
                            <img class="card-img-top lazy" src="{{ asset($course->feature_image) }}" data-src="{{ asset($course->feature_image) }}" alt="Card image cap">
                        </a>
                        @php
...
@php
    $courseData = App\Models\Course::all();
@endphp
