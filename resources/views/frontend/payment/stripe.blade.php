...
<section class="cart-area section--padding">
    <div class="container">
        <div class="row">
            <div class="col-lg-7">
                <form method="post" id="payment-form" class="row" action="{{ route('stripe_order') }}" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="order-details-lists">
                                ...
                                <div class="media media-card border-bottom border-bottom-gray pb-3 mb-3">
                                    ...
                                    <div class="media-body">
                                        <h5 class="fs-15 pb-2"><a href="{{ url('courses/'.$item->id.'/'.$item->options->slug) }}">{{ $item->name }} </a></h5>
