                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" class="pt-4" action="{{ route('login') }}">
                            ...
                            <div class="flex-wrap pb-4 d-flex align-items-center">
                                {{-- <a href="{{ url('/auth/google') }}" class="mx-2 mb-2 btn theme-btn flex-grow-1"><i class="mr-2 la la-google"></i>Google</a> --}}
                            ...
                            <div class="input-box">
                                ...
                                <div class="form-group">
                                    <input class="form-control form--control" type="email" id="email" name="email" placeholder="Email or Username">
                            ...
                            <div class="btn-box">
                                <div class="pb-4 d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="custom-control custom-checkbox fs-15">
                                        ...
                                        <label class="custom-control-label custom--control-label" for="newsletter">Subscribe to our newsletter</label>
                                    </div><!-- end custom-control -->
                                ...
                                <p class="pt-2 fs-14">Don't have an account? <a href="{{ route('register') }}" class="text-color hover-underline">Register</a></p>
                            </div><!-- end btn-box -->
                        </form>
                    </div><!-- end card-body -->
                </div><!-- end card -->
