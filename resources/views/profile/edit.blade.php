    ...
    <div class="container">
        <div class="main-body">
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                @endphp
                                <img src="{{ $profile_img }}" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">
                                <div class="mt-3">
                                    <h4>{{ $user->name }}</h4>
                ...
                <div class="col-lg-8">
                    <div class="card">
                        <form action="" method="post" enctype="multipart/form-data" action="{{ route('profile.update') }}">
                            @method('PATCH')
                            @csrf
                            <div class="card-body">
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img src="{{ $profile_img }}" id="show_image" alt="Admin" class="rounded-circle p-1 bg-primary" width="80">
                                    </div>
                                </div>
                                <div class="row">
