...
@php
    ...
    $instructor_img = (empty($profileData->photo)) ? asset('backend/assets/images/avatars/avatar-2.png') : asset("upload/$profileData->photo");
    $instructor_img = (empty($profileData->photo)) ? asset('backend/assets/images/avatars/avatar-2.png') : asset("upload/$profileData->photo");
    $user_photo = $question['user']['photo'];
    $user_img = (empty($user_photo)) ? asset('backend/assets/images/avatars/avatar-2.png') : asset("upload/$user_photo")
@endphp
    ...
    <div class="chat-wrapper">
            ...
            <div class="chat-sidebar-header">
                <div class="d-flex align-items-center">
                    <div class="chat-user-online">
                        <img src="{{ $instructor_img }}" width="45" height="45" class="rounded-circle" alt="" />
                    </div>
                        ...
                        <div class="chat-list">
                            <div class="list-group list-group-flush">
                                <a href="javascript:;" class="list-group-item">
                                    <div class="d-flex">
                                        <div class="chat-user-online">
                                            <img src="{{ $user_img }}" width="42" height="42" class="rounded-circle" alt="" />
                                        </div>
                                        <div class="flex-grow-1 ms-2">
        ...
        <div class="chat-content">
            <div class="chat-content-leftside">
                <div class="d-flex">
                    <img src="{{ $user_img }}" width="48" height="48" class="rounded-circle" alt="" />
                    <div class="flex-grow-1 ms-2">
